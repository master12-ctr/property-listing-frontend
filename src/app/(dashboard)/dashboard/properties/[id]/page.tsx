...
export default function DashboardPropertyDetailPage() {
  ...
  const canFavorite = isPublished && !isOwner && !isAdmin;
  ...
  const showContactForm = isPublished && !isOwner && user && !isAdmin;
  ...
  <a href="/dashboard/properties" className="text-gray-600 hover:text-blue-600">
    Properties
  </a>
</li>
            <li>
        ...
        <div className="space-y-6">
          ...
          {showContactForm ? (
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-6">
              <h2 className="text-xl font-bold text-purple-800 mb-4">Admin View</h2>
              <p className="text-purple-700">
                As an admin, you can manage this property but cannot contact the owner.
              </p>
            </div>
          ) : !isPublished ? (
